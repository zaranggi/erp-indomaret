    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <fieldset class="mb-3">
                ...
                <form method="post" action="{{ route('karyawan.update', $users->id) }}">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="department" data-placeholder="Select a Department" class="form-control select-icons" data-fouc>
