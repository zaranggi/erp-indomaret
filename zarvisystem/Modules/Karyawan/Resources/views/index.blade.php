...
@section('content')
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title"> Manage - Karyawan<br/>
            </h5>
                        ...
                        <div class="list-icons">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-158px, 19px, 0px);">
                                    ...
                                    <a href="{{ route('karyawan.destroy', $r->id) }}" data-method="delete" data-confirm="Are you sure?" rel="nofollow" class="dropdown-item">
