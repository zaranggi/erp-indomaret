                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group form-group-feedback form-group-feedback-left">
                                        ...
                                        <input type="email" name="email"  class="form-control form-control-lg" placeholder="email@email.com">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="jabatan" data-placeholder="Select a Jabatan" class="form-control select-icons" data-fouc required>
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="department" data-placeholder="Select a Department" class="form-control select-icons" data-fouc required>
