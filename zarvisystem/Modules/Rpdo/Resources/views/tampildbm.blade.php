        ...
        <table class="table datatable-button-html5-columns">
            ...
            @foreach($list as $r)
                ...
                <tr >
                    ...
                    <td class="text-center text-info font-weight-bold">{{ \App\Helpers\Tanggal::periode($r->last_update) }}</td>
                    <td class="text-center text-info font-weight-bold">Minggu ke - {{ $r->minggu }}</td>
                    <td class="text-center font-weight-bold mb-1"><span class="badge badge-mark border-danger mr-1"></span>

                        {{ $r->total_dep }}</td>
                    <td class="text-center text-warning font-weight-bold"><i class="icon-statistics mr-2"></i> Rp {{  number_format($r->total_pdo) }}</td>
                    ...
                    <td class="text-center">
                            <a href="#" class="text-pink-400"
                               onclick="javascript: openwindow('{{ url('rpdo/previewdbmall/'. $r->minggu.'/'.$periode) }}')">
