                    ...
                    <div class="col-sm-6">
                        <div class="mb-4">
                            <div class="text-sm-right">
                                <ul class="list list-unstyled mb-0">
                                    <li>Created at: <span class="font-weight-semibold text-warning">{{ \App\Helpers\Tanggal::periode($tanggal)}}</span></li>


                                </ul>

                                <h5 class="text-primary mb-2 mt-md-2"> </h5>
                                <span class="text-success mb-2 font-weight-bold"> Minggu Ke - {{ $minggu}}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class=" row">
                        <div class="col-md-12 text-right">
                            &nbsp;&nbsp;&nbsp;
                                ...
                                <img src="{{ asset("images/approve.jpg") }} "  class="mb-3 mt-2 img-responsive" alt="" width="200" >
