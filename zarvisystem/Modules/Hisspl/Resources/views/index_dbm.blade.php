...
<div class="row justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body border-left-3 border-left-blue-400 rounded-left-0">
                    ...
                    <div class="col-md-8 ">
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary"
                                ...
                                <i class="icon-eye4  "></i> Preview </button>
                        </div>
                    </div>
                </form>
            </fieldset>
            ...
            <hr>
            <div class="card-body border-left-3 border-left-indigo-400 rounded-left-0">

                <fieldset class="mb-3">

                    <legend class="text-uppercase font-size-sm font-weight-bold text-warning-600">Form Download </legend>
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/hisspl/downloadExcel') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <div class="row">
                                    <div class="col-md-4">
                                        <input name="tanggal" type="text" data-date-format="yyyy-mm" class="form-control mb-3 mb-md-0" id="tanggal2" placeholder="Periode Lembur">
                                    </div>
