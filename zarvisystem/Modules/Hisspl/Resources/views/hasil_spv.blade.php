        ...
        <div class="card-header bg-dark text-white d-flex justify-content-between">
            ...
            <span class="font-size-sm text-uppercase font-weight-semibold">Status ::
                ...
                @elseif($status_lembur == 3)
                    <?php echo "Rejected"; ?>
                @elseif($status_lembur == 1)
                    <?php echo "Pending"; ?>
                @endif</span>
        </div>

        <div class="card-header header-elements-inline">
            <h5 class="card-title text-success font-weight-bold"> Supervisor : {{ Auth::user()->name }}<br/></h5>
        </div>
        ...
        <div class="card-body border-left-3 border-left-blue-400 rounded-left-0">
            ...
            <table class="table datatable-button-html5-columns">
                ...
                <tr class="font-size-md bg-info">
                    ...
                    <td class="text-center">{{  number_format($TOTAL_LEMBUR,1) }} Jam</td>
                </tr>
