                    ...
                    <div class="row">
                        ...
                        <div class=" row">
                            <div class="col-md-12 text-center">
                                @if($status == "1")
                                    <a href="{{ url('listpdo/appmgr/'.$r->kode_trx)  }}"  onClick= "return confirm('Apakah Anda Yakin?')"
                                       class="btn btn-primary text-center">
                                        Approve <i class="icon-checkmark4   ml-2"></i>
                                    </a>
                                &nbsp;&nbsp;&nbsp;
                                    <a href="{{ url('listpdo/rjmgr/'.$r->kode_trx)  }}"  onClick= "return confirm('Apakah Anda Yakin?')"
