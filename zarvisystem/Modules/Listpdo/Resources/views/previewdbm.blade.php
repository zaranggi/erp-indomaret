                    ...
                    <div class="col-sm-6">
                        <div class="mb-4">
                            ...
                            <ul class="list list-unstyled mb-0">
                                ...
                                <li><span class="font-weight-semibold text-indigo">{{ $r->nama_mgr }}</span></li>
                    ...
                    <div class="row">
                        ...
                        <div class=" row">
                            <div class="col-md-12 text-center">
                                @if($status == "2")
                                    <a href="{{ url('listpdo/appdbm/'.$r->kode_trx)  }}"  onClick= "return confirm('Apakah Anda Yakin?')"
                                       class="btn btn-primary text-center">
                                        Approve <i class="icon-checkmark4   ml-2"></i>
                                    </a>
                                &nbsp;&nbsp;&nbsp;
                                    <a href="{{ url('listpdo/rjdbm/'.$r->kode_trx)  }}"  onClick= "return confirm('Apakah Anda Yakin?')"
                                       class="btn btn-danger text-center">
                                        Reject <i class="icon-cross2  ml-2"></i>
                                    </a>
                                @endif
                                &nbsp;&nbsp;&nbsp;
                                <a href="{{ url('listpdo')  }}" class="btn btn-warning text-center">Back <i class="icon-backward2 ml-2"></i></a>
