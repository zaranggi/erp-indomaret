...
@section('styles')
    ...
    <!-- Morris charts -->
    <link rel="stylesheet" href="{{ asset('/global_assets/js/morris/morris.css') }}">
@stop
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-header header-elements-inline ">
                    ...
                    <h4 class="card-title text-center text-indigo-400 font-weight-bold ">Trend Lembur<br/>
                ...
                <div class="card-body border-left-3 border-left-blue-400 rounded-left-0">
                    <fieldset class="mb-3">
                        <table class="table datatable-button-html5-columns" id="ada">
                            <thead>
                            <tr>
                                <th >No</th>
                                <th>Departemen</th>
                            ...
                            @foreach($dep as $r)
                                <tr>
                                    ...
                                    <td  class="text-left">{{$r->name_department}}</td>
                                    <td  class="text-left">{{$r->name}}</td>
                                    @for($x = 1; $x<=$total_bulan;$x++)
                                        <td  class="text-center"> {{ $detail[$r->nik][$x] }} </td>
                                    @endfor
                            ...
                            <tfoot>
                            <tr class="font-weight-bold" style="background: #1fe0c7;">
                                <td class="text-center" colspan="3">Trend Total Lembur</td>
                                @for($x = 1; $x<=$total_bulan;$x++)
...
@section('scripts')
    ...
    <script src="{{ asset('/global_assets/js/raphael-min.js') }}"></script>
    <script src="{{ asset('/global_assets/js/morris/morris.min.js') }}"></script>
    <script>
        /* ------------------------------------------------------------------------------
 *
            ...
            var _componentDatatableButtonsHtml5 = function() {
                ...
                $('.datatable-button-html5-columns').DataTable({
                    "footerCallback": function ( row, data, start, end, display ) {
                        ...
                        @for($x = 1; $x<=$total_bulan;$x++)
                        $( api.column( {{2 + $x}} ).footer() ).html(totalnya{{$x}});
                        @endfor
    ...
    <script type="text/javascript">
        $(function () {
            new Morris.Line({
                ...
                ykeys: [<?php echo $listnik; ?>],
                labels: [ <?php echo $listdep; ?>],
                lineColors: ['#f73e3e', '#f7943e', '#e4f73e', '#97f73e', '#3ef766', '#3ee1f7', '#603ef7','#e83ef7','#f73e7f','#f70a0a' ],
