                ...
                <!-- Dashboard content -->
                    <div class="card-body">
                        <div class="row text-center">
                            ...
                            <div class="col-3">
                                <p><a href="{{url('spl')}}" class="btn bg-transparent border-info-400 text-info-400 rounded-round border-3 btn-icon mr-2">
                                        <i class="icon-bookmark icon-3x "></i></a>
                                </p>
                                <h5 class="font-weight-semibold mb-0"> *  </h5>
                                <span class="text-muted font-size-sm">Pengajuan SPL</span>
                            </div>
