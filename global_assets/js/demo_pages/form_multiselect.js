...
var BootstrapMultiselect = function() {
    ...
    var _componentMultiselect = function() {
        ...
        // Initialize MENU
        $('.multiselect-toggle-selection-dep').multiselect();

        // Toggle selection on button click
        $('.multiselect-toggle-selection-button-dep').on('click', function(e) {
            e.preventDefault();
            multiselect_toggle($('.multiselect-toggle-selection-dep'), $(this));
        });

        $('.multiselect-toggle-selection-access').multiselect();

        // Toggle selection on button click
        $('.multiselect-toggle-selection-button-access').on('click', function(e) {
            e.preventDefault();
            multiselect_toggle($('.multiselect-toggle-selection-access'), $(this));
        });

        $('.multiselect-toggle-selection-add').multiselect();

        // Toggle selection on button click
        $('.multiselect-toggle-selection-button-add').on('click', function(e) {
            e.preventDefault();
            multiselect_toggle($('.multiselect-toggle-selection-add'), $(this));
        });

        $('.multiselect-toggle-selection-update').multiselect();

        // Toggle selection on button click
        $('.multiselect-toggle-selection-button-update').on('click', function(e) {
            e.preventDefault();
            multiselect_toggle($('.multiselect-toggle-selection-update'), $(this));
        });
        $('.multiselect-toggle-selection-delete').multiselect();

        // Toggle selection on button click
        $('.multiselect-toggle-selection-button-delete').on('click', function(e) {
            e.preventDefault();
            multiselect_toggle($('.multiselect-toggle-selection-delete'), $(this));
        });
        $('.multiselect-toggle-selection-upload').multiselect();

        // Toggle selection on button click
        $('.multiselect-toggle-selection-button-upload').on('click', function(e) {
            e.preventDefault();
            multiselect_toggle($('.multiselect-toggle-selection-upload'), $(this));
        });
